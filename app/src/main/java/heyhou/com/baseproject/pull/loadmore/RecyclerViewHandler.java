package heyhou.com.baseproject.pull.loadmore;
...
import heyhou.com.baseproject.adapter.HeaderAndFooterWrapper;
import heyhou.com.baseproject.pull.recyclerview.RecyclerAdapterWithHF;
...
public class RecyclerViewHandler implements LoadMoreHandler {
    ...
    public boolean handleSetAdapter(View contentView, ILoadMoreViewFactory.ILoadMoreView loadMoreView, OnClickListener onClickLoadMoreListener) {
        ...
        if(recyclerView.getAdapter() instanceof HeaderAndFooterWrapper){
            mRecyclerAdapter = (RecyclerAdapterWithHF) (((HeaderAndFooterWrapper) recyclerView.getAdapter()).getWrapperAdapter());
        }else{
