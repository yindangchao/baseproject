package heyhou.com.baseproject.pull.header;
...
import heyhou.com.baseproject.pull.PtrUIHandler;
import heyhou.com.baseproject.pull.indicator.PtrIndicator;
import heyhou.com.baseproject.pull.utils.PtrLocalDisplay;
...
public class StoreHouseHeader extends View implements PtrUIHandler {
    ...
    public heyhou.com.baseproject.pull.header.StoreHouseHeader setLineWidth(int width) {
        mLineWidth = width;
    ...
    public heyhou.com.baseproject.pull.header.StoreHouseHeader setTextColor(int color) {
        mTextColor = color;
        for (int i = 0; i < mItemList.size(); i++) {
    ...
    public heyhou.com.baseproject.pull.header.StoreHouseHeader setDropHeight(int height) {
        mDropHeight = height;
        return this;
    }
