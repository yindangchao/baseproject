...
import heyhou.com.baseproject.pull.indicator.PtrIndicator;
import heyhou.com.baseproject.pull.loadmore.DefaultLoadMoreViewFooter;
import heyhou.com.baseproject.pull.loadmore.GridViewHandler;
import heyhou.com.baseproject.pull.loadmore.ILoadMoreViewFactory;
import heyhou.com.baseproject.pull.loadmore.ListViewHandler;
import heyhou.com.baseproject.pull.loadmore.LoadMoreHandler;
import heyhou.com.baseproject.pull.loadmore.OnLoadMoreListener;
import heyhou.com.baseproject.pull.loadmore.OnScrollBottomListener;
import heyhou.com.baseproject.pull.loadmore.RecyclerViewHandler;
import heyhou.com.baseproject.pull.utils.PtrCLog;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray arr = context.obtainStyledAttributes(attrs, heyhou.com.baseproject.R.styleable.PtrFrameLayout, 0, 0);
        if (arr != null) {

            mHeaderId = arr.getResourceId(heyhou.com.baseproject.R.styleable.PtrFrameLayout_ptr_header, mHeaderId);
            mContainerId = arr.getResourceId(heyhou.com.baseproject.R.styleable.PtrFrameLayout_ptr_content, mContainerId);

            mPtrIndicator.setResistance(
                    arr.getFloat(heyhou.com.baseproject.R.styleable.PtrFrameLayout_ptr_resistance, mPtrIndicator.getResistance()));

            mDurationToClose = arr.getInt(heyhou.com.baseproject.R.styleable.PtrFrameLayout_ptr_duration_to_close, mDurationToClose);
            mDurationToCloseHeader = arr.getInt(heyhou.com.baseproject.R.styleable.PtrFrameLayout_ptr_duration_to_close_header, mDurationToCloseHeader);

            float ratio = mPtrIndicator.getRatioOfHeaderToHeightRefresh();
            ratio = arr.getFloat(heyhou.com.baseproject.R.styleable.PtrFrameLayout_ptr_ratio_of_header_height_to_refresh, ratio);
            mPtrIndicator.setRatioOfHeaderHeightToRefresh(ratio);

            mKeepHeaderWhenRefresh = arr.getBoolean(heyhou.com.baseproject.R.styleable.PtrFrameLayout_ptr_keep_header_when_refresh, mKeepHeaderWhenRefresh);

            mPullToRefresh = arr.getBoolean(heyhou.com.baseproject.R.styleable.PtrFrameLayout_ptr_pull_to_fresh, mPullToRefresh);
            arr.recycle();
        }
...
//        mPagingTouchSlop = conf.getScaledTouchSlop() * 2;
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        if (!isEnabled() || mContent == null || mHeaderView == null || !isCanScroll) {
...
//                        && (Math.abs(offsetX) > mPagingTouchSlop
    ...
    private boolean isLoadMoreNomore = false;
    ...
    public void loadMoreComplete(boolean hasMore) {
        ...
        if (hasMore) {
            ...
            isLoadMoreNomore = true;
            setNoMoreData();
        }
    }

    public boolean isLoadMoreNomore() {
        return isLoadMoreNomore;
    }
