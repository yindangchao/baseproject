...
import heyhou.com.baseproject.glidetolls.GlideImgManager;
...
public class CommViewHolder {
    ...
    public CommViewHolder setText(int viewId, Spanned text) {
        TextView view = getView(viewId);
        view.setText(text);
        return this;
    }
...
//        BaseApplication.imageLoader.displayImage(url, (ImageView) getView(viewId), BaseApplication.options);
        GlideImgManager.loadImage(mContext, url, (ImageView) getView(viewId));
        return this;
    }

//    public CommViewHolder setImageByUrl(final int viewId, String url, DisplayImageOptions option) {
//        BaseApplication.imageLoader.displayImage(url, (ImageView) getView(viewId), option);
//        return this;
//    }
