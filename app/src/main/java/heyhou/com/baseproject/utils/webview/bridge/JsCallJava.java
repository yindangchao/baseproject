package heyhou.com.baseproject.utils.webview.bridge;
...
//            sb.append("var tid=setInterval(function(){if(b.hh&&b.hh.ready){b.hh.ready();clearInterval(tid)}},500);");
//            sb.append("var tid=setInterval(function(){if(b.hh&&b.hh.ready){b.hh.ready();clearInterval(tid)}},2000);");
            sb.append("})(window);");
            mPreloadInterfaceJS = sb.toString();
            Log.e(TAG, "mPreloadInterfaceJS : -------------->>>" + mPreloadInterfaceJS);
        } catch(Exception e){
