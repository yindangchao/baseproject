...
public class AnimatorUtils {
    ...
    //播放动画集合
    public static void playAnimatorArray(ArrayList<Animator> animators,AnimatorPlayType playType,@Nullable final FreeAnimatorListener animatorListener){
        AnimatorSet set = new AnimatorSet();
        switch (playType){
            case Sequentially:
                set.playSequentially(animators);
...
//        objectAnimator.start();
     ...
     * @return
     */
    public static Animator translationAnimator(View view,int startTranslationX,int endTranslationX,int startTranslationY,int endTranslationY,long duration,@Nullable TimeInterpolator timeInterpolator,@Nullable final FreeAnimatorListener animatorListener){
        ObjectAnimator objectAnimatorX = null;
        ObjectAnimator objectAnimatorY = null;
//        if(endTranslationX != 0){
            objectAnimatorX = ObjectAnimator.ofFloat(view, View.TRANSLATION_X, startTranslationX, endTranslationX);
            objectAnimatorX.setDuration(duration);
//        }
//        if(endTranslationY != 0){
            objectAnimatorY = ObjectAnimator.ofFloat(view, View.TRANSLATION_Y, startTranslationY, endTranslationY);
...
//        }
     ...
     * @return
     */
    public static Animator viewBackgroundEvaluateChangeAnimator(final View view, final int startLeftColor, final int startRightColor, final int endLeftColor, final int endRightColor, long duration, @Nullable final FreeAnimatorListener animatorListener){
...
//        valueAnimator.start();
     ...
     * @return
     */
    public static Animator textViewColorChangeAnimator(final TextView textView, final int startColor, final int endColor, long duration,@Nullable final FreeAnimatorListener animatorListener){
        ValueAnimator valueAnimator = ValueAnimator.ofFloat(0f, 1f);
        valueAnimator.setDuration(duration);
        final ArgbEvaluator argbEvaluator = new ArgbEvaluator();
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
